...
#if DEBUG
struct SDOHTem_Previews : PreviewProvider {
    static var previews: some View {
        SDOHTem(name: "Alabama Top 10 Drivers of Comorbidity", headline: "Comorbidity: All Comorbidities ",
                top1:"Patient Age",
                ...
                top10:"% Change in Rate of Stroke",state:"Alabama")
    }
}
#endif
