...
extension PieChartDemoView {
    static func makeData() -> PieChartData {
        ...
        let data = PieDataSet(
            dataPoints: [
                PieChartDataPoint(value: 39.5, description: "% of Obese",   colour: Color("Custom Colour")  , label: .icon(systemName: "1.square", colour: .white, size: 30)),
                PieChartDataPoint(value: 33.8, description: "% of Overweight",   colour: Color("Grey")   , label: .icon(systemName: "2.square", colour: .white, size: 30)),
                PieChartDataPoint(value: 26.7, description: "% Not Obese or Overweight", colour: Color("Sea Blue"), label: .icon(systemName: "3.square", colour: .white, size: 30)),
